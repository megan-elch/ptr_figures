...
load("model_output/p3_ag_cor.RData")
cor_df = cor_df %>% mutate(pop = "Protein Pop3")
cor_df_prot = cor_df_prot %>% rbind(cor_df)
...
load("model_output/p1_p3_ac_cor.RData")
cor_df = cor_df %>% mutate(pop = "P13")
cor_df_prot = cor_df_prot %>% rbind(cor_df)
...
load("model_output/p2_p3_ac_cor.RData")
cor_df = cor_df %>% mutate(pop = "P23")
cor_df_prot = cor_df_prot %>% rbind(cor_df)
...
load("model_output/p3_p4_ac_cor.RData")
cor_df = cor_df %>% mutate(pop = "P34")
cor_df_prot = cor_df_prot %>% rbind(cor_df)
...
load("model_output/m1_p3_ac_cor.RData")
cor_df = cor_df %>% mutate(pop = "m1p3")
cor_df_multi = cor_df_multi %>% rbind(cor_df)

load("model_output/m2_p3_ac_cor.RData")
cor_df = cor_df %>% mutate(pop = "m2p3")
cor_df_multi = cor_df_multi %>% rbind(cor_df)
...
p2 = plot_zscore_means(mrna_z = list(mrna_pop1_z, mrna_pop2_z), 
                       ...
                       clusters = clusters, mrna_pop_label = c("Pop1", "Pop2"), protein_pop_label = c("Pop1", "Pop2", "Pop3", "Pop4"),
